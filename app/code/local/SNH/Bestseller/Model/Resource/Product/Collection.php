<?php
class SNH_Bestseller_Model_Resource_Product_Collection extends Mage_Reports_Model_Resource_Product_Collection
{    
    /**
     * Add ordered qty's
     *
     ...
     */
    public function addOrderedQty($from = '', $to = '', $_category_id = 0)
    {      
        ...
        $orderJoinCondition   = array(
			...
			$adapter->quoteInto("{$orderTableAliasName}.store_id= ?",  Mage::app()->getStore()->getId()),
        );
		...
		if ($_category_id == 0) { $_category_id = Mage::app()->getStore()->getRootCategoryId(); }
